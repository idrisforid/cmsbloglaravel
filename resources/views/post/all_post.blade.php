          ...
          <header class="bg-dark text-white py-3">
          	<div class="container">
                ...
                <div class="col-lg-3 mb-2">
                  <a href="{{'/create-post'}}" class="btn btn-primary btn-block">
                ...
                <div class="col-lg-3 mb-2">
                  <a href="{{'/comment-approval'}}" class="btn btn-success btn-block">
                 ...
                 <table class="table table-striped table-hover">
                   <thead class="thead-dark">
                     ...
                     <tr>
                       ...
                       <td><img src="{{asset('uploads/posts/'.$row->image)}}" height="70px;" width="170px;"></td>

                       <td><a href="{{'/edit-post/'.$row->id}}"><span class="btn btn-warning"> Edit</span></a>
                       <a href="{{'/delete-show/'.$row->id}}"><span class="btn btn-danger">Delete</span></a></td>
                       <td> <a href="{{'/full-post/'.$row->id}}"> <span class="btn btn-primary">Live Preview</span></a></td>
